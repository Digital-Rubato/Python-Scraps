...
class Character:
	""" character container for this rpg game. _health, _attack, _dodge are all instantiated from 		the dictionary of types from above (respectively) """
	...
	def _dodge_success(self):
		# Every point in dodge equals 5% chase to dodge
...
choice_1 = input("Choose your character, fighter, thief, or mage: ")
choice_2 = input("Choose your second character: ")
